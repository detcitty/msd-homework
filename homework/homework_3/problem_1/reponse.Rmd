...
# Answer
	...
	If this were a directed graph within a close-friend network, 
	there will be less new paths to follow in which there will always be new people. 
	Close friends have ties to people they know.
	There friends are close to them.
  There would be more number of clusters
  
  In the distant friend case, there would be a higher chance of meeting someone
  new all the time, since it would be more likely that your least closest friends
  are not the same as the other person's lease closest friends.
